    ...
    throw new IOException(
        String.format(
            "The Application Default Credentials are not available. "
                + "They are available if running on Google App Engine, "
                + "Google Compute Engine, or Google Cloud Shell. Otherwise, "
        ...
        new IOException(
            String.format(
                "Application Default Credentials failed to create the Google App Engine "
                    + " service account credentials class %s. Check that the component "
        ...
        throw new IOException(
            String.format(
                "Error code %s trying to get security access token from"
                    + " Compute Engine metadata for the default service account. "
                    + " This may be because the virtual machine instance does not "
                    + " have permission scopes specified.",
                statusCode));
      }
      throw new IOException(
          String.format(
